...
const ProjectDetails = ({title, description, subDescription, href, 
  ...
  return (
    ...
    w-full   h-full overflow-hidden backdrop-blur-sm'>
      ...
      bg-gradient-to-ç from-midnight to-navy border-white/10'
        ...
        hover:bg-gray-500'>
            ...
            <div>
                ...
                <div className='flex items-center justify-between mt-4'>
                    ...
                    gap-1 font-medium hover-animation cursor-pointer hover-animation' href="">View Project <img 
                    src="assets/arrow-up.svg" className='size-4' /></a>
                </div>
            </div>
        </button>
      </motion.div>
